...
Mirrored source (https://github.com/sophos-iaas/xg-azure/) and modified to not create an unused availbility set. Next version will also set static private IPs on NICs.
